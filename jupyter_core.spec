...
Source0  : https://files.pythonhosted.org/packages/46/54/aa5d2ec9aad97d696970c1f64f36fc82c14057734d3c8cfa2e0c79f114fb/jupyter_core-4.7.0.tar.gz
...
%prep
%setup -q -n jupyter_core-4.7.0
cd %{_builddir}/jupyter_core-4.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608011090
...
cp %{_builddir}/jupyter_core-4.7.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_core/caf2cfb9faff40412b9975dec725e241814cc46b
