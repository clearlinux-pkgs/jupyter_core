...
Version  : 4.9.0
Release  : 50
URL      : https://files.pythonhosted.org/packages/e8/24/56cf7a9d33572f20bbfa142f963d0acc61fac5127859fa0683508799428c/jupyter_core-4.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e8/24/56cf7a9d33572f20bbfa142f963d0acc61fac5127859fa0683508799428c/jupyter_core-4.9.0.tar.gz
...
%prep
%setup -q -n jupyter_core-4.9.0
cd %{_builddir}/jupyter_core-4.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635347886
...
cp %{_builddir}/jupyter_core-4.9.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_core/caf2cfb9faff40412b9975dec725e241814cc46b
