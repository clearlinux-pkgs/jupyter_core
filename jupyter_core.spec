...
Version  : 4.8.2
Release  : 49
URL      : https://files.pythonhosted.org/packages/92/55/3db48742660b8d2cf32ed508c71578bf9e4d80fe9ed002d0b611c9debae3/jupyter_core-4.8.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/92/55/3db48742660b8d2cf32ed508c71578bf9e4d80fe9ed002d0b611c9debae3/jupyter_core-4.8.2.tar.gz
...
%prep
%setup -q -n jupyter_core-4.8.2
cd %{_builddir}/jupyter_core-4.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635294610
...
cp %{_builddir}/jupyter_core-4.8.2/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_core/caf2cfb9faff40412b9975dec725e241814cc46b
