...
Source0  : https://files.pythonhosted.org/packages/24/9a/0ca76ccc95eeb3ee376c671e81bda2c61d148c7627443004d1ba0d085b80/jupyter_core-4.7.1.tar.gz
...
%prep
%setup -q -n jupyter_core-4.7.1
cd %{_builddir}/jupyter_core-4.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612193478
...
cp %{_builddir}/jupyter_core-4.7.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_core/caf2cfb9faff40412b9975dec725e241814cc46b
