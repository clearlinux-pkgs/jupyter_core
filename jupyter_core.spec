...
Source0  : https://files.pythonhosted.org/packages/bb/dc/bb0e8b5093582699271df99cad202390e5cfcdb6bc5e772ca2fa8f61ade6/jupyter_core-4.8.1.tar.gz
...
%prep
%setup -q -n jupyter_core-4.8.1
cd %{_builddir}/jupyter_core-4.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631891884
...
cp %{_builddir}/jupyter_core-4.8.1/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_core/caf2cfb9faff40412b9975dec725e241814cc46b
