...
Source0  : https://files.pythonhosted.org/packages/a6/cd/6369e30b4cda4769401d0654f917302edef6395630822a20996b25361eb5/jupyter_core-4.6.2.tar.gz
...
%prep
%setup -q -n jupyter_core-4.6.2
cd %{_builddir}/jupyter_core-4.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581433332
...
cp %{_builddir}/jupyter_core-4.6.2/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_core/caf2cfb9faff40412b9975dec725e241814cc46b
